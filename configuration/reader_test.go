...
var (
	...
	expectedGetEnvFallbackArgs = []string{"TRANSLATION_ENDPOINT", "/", "GROUP_ENDPOINT", "/groups", "VERSION_ENDPOINT", "/version", "VERSION", "0"}
...
func TestReadConfiguration(t *testing.T) {
	...
	if mockWrapper.GetEnvFallbackWasCalled != 4 {
		t.Errorf("GetEnvFallback was not called valid amount of times: %v instead of 4", mockWrapper.GetEnvFallbackWasCalled)
	}
